...
Recomenda-se o uso do Android Studio 4.1.2, pois o código inicial foi criado nessa versão da IDE.
...
Antes de iniciar a implementação, acesse o link do GitHub Classroom deste exercício para criar uma cópia do código base.
